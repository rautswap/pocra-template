				...
				if (url) {
					fetch(url)
						...
						.then((html) => {
							...
							// 		// 'CQL_FILTER': indate
							// 		'viewparams': "vinCode :" + jsondata.features[0].properties.vincode
							// 	},
							// })
