		...
		return (
			<div>
				<table >
					...
					<tr>
						<td><img src="dist/legend/appl_1.png" height={'20px'} width={'25px'} />  </td>

						<td>0 - {this.props.props.appl_1} </td>
					</tr>
					<tr>
						<td><img src="dist/legend/appl_2.png" height={'20px'} width={'25px'} />  </td>

						<td>{this.props.props.appl_1 + 0.1} - {this.props.props.appl_2} </td>
					</tr>
					<tr>
						<td><img src="dist/legend/appl_3.png" height={'20px'} width={'25px'} />  </td>

						<td>{this.props.props.appl_2 + 0.1} - {this.props.props.appl_3} </td>
					</tr>
					<tr>
						<td><img src="dist/legend/appl_4.png" height={'20px'} width={'25px'} />  </td>

						<td>{this.props.props.appl_3 + 0.1} - {this.props.props.appl_4} </td>
					</tr>
					<tr>
						<td><img src="dist/legend/appl_5.png" height={'20px'} width={'25px'} />  </td>
